...
export default function Todo() {
    ...
    const apiUrl = "https://mern-todos-965h.onrender.com"
   ...
   useEffect(()=>{
    ...
    return <>
        <div className="row p-3 bg-success text-light mt-3">
        ...
        <div className="row mt-3">
            ...
            <div className="col-md-6">
                ...
                <ul className="list-group">
                    { 
                    todos.map((item,index) =>  <li className="list-group-item bg-info d-flex justify-content-between align-items-center my-2" key={index} >
